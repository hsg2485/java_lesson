...
//C35 클래스를 1) 객체를 만들어서 2) static 인 것들 테스트
//	(참고: main 메소드를 갖는 클래스를 객체로 만들지 않는 것이 일반적임)
	public static void main(String[] args) {
		...
		//C35 클래스에서 static이 아닌 인스턴스 변수에는 객체마다 다른 값을 저장함
		test1.count = 10;
		test2.count = 20;
		...
		//C35_GlobalVar.Test = 100;	//오류: final은 값 변경 못함
		
		C35_GlobalVar test3 = new C35_GlobalVar();
		//전역변수의 기본 초기값?		- 0, 0.0, 참조타입은 null, 그리고 나머지는 오류
		//참고: 지역변수의 기본 초기값?
