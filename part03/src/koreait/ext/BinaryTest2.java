...
public class BinaryTest2 {
	...
	public static void main(String[] args) {
		...
		int n2 = 0b1010010000011100;		//2진수 표기는 0b로 시작함
		
		System.out.println("1. 변수를 그대로 출력");
		System.out.println("10진수 리터럴 123 : " + n10);
		System.out.println("16진수 리터럴 0xa41c : " + n16);		//정수값 출력은 format 지정 안하면 10진수로 출력됨
		...
		//결론 : 10진수 42012, n16과 n2 변수 값이 메모리에 저장될 때는 모두 동일한 0,1 표현값임
		...
		System.out.println("3. 입력한 2진수 또는 16진수 값을 10진수로 바꾸어 드립니다");
		...
		System.out.println(String.format("2진수 %s 는 10진수 %d 입니다", 
				t2, Long.parseLong(t2, 2)));	//t2는 2진수 => 메소드 결과 정수값
		System.out.println(String.format("16진수 %s 는 10진수 %d 입니다", 
				t16, Long.parseLong(t16, 16)));	//t16은 16진수 => 메소드 결과 정수값
